...
|----|-------|-------|--------|--------|
| ph-0-us-1 | Expo project scaffolded with custom dev client | Frontend | — | Not Started |
| ph-0-us-2 | Firebase project provisioned and wired into the app | Parent | — | Not Started |
| ph-0-us-3 | Provision the Firebase project (Firestore, Hosting, Analytics) | Backend | ph-0-us-2 | Not Started |
